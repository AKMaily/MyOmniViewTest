...
namespace ImGui
{
  inline void SetupImGuiStyle(bool bStyleDark_, float alpha_)
  {
    ...
    style.Colors[ImGuiCol_Text] = ImVec4(248/255.0f, 249/255.0f, 250/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_TextDisabled] = ImVec4(248/255.0f, 249/255.0f, 250/255.0f, 98/100.0f);
    style.Colors[ImGuiCol_WindowBg] = ImVec4(37/255.0f, 40/255.0f, 43/255.0f, 100/100.0f);
    ...
    style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(23/255.0f, 23/255.0f, 20/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_TitleBgActive] =ImVec4(23/255.0f, 23/255.0f, 20/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_MenuBarBg] = ImVec4(23/255.0f, 23/255.0f, 20/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(23/255.0f, 23/255.0f, 20/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(248/255.0f, 249/255.0f, 250/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered] =
        ImVec4(245/255.0f, 245/255.0f, 245/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ScrollbarGrabActive] =
        ImVec4(240/255.0f, 240/255.0f, 240/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_CheckMark] = ImVec4(235/255.0f, 62/255.0f, 54/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_SliderGrab] = ImVec4(245/255.0f, 245/255.0f, 245/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(240/255.0f, 240/255.0f, 240/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_Button] = ImVec4(37/255.0f, 40/255.0f, 43/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(240/255.0f, 62/255.0f, 54/255.0f, 100/100.0f);
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(235/255.0f, 62/255.0f, 54/255.0f, 100/100.0f);
